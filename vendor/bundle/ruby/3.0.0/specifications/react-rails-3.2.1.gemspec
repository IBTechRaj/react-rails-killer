...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<bundler>.freeze, ["= 2.4.9"])
    ...
    s.add_development_dependency(%q<package_json>.freeze, [">= 0"])
    s.add_development_dependency(%q<rails>.freeze, ["~> 7.0.7", ">= 7.0.7.2"])
    s.add_development_dependency(%q<turbo-rails>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<bundler>.freeze, ["= 2.4.9"])
    ...
    s.add_dependency(%q<package_json>.freeze, [">= 0"])
    s.add_dependency(%q<rails>.freeze, ["~> 7.0.7", ">= 7.0.7.2"])
